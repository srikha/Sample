...
(./bin/${binary} -warmup_instructions ${n_warm}0000 -simulation_instructions ${n_sim}0000 ${option} -traces ${TRACE_DIR}/${trace1}.trace.gz ${TRACE_DIR}/${trace2}.trace.gz &> results_2core/${trace1}-${trace2}-${binary}${option}.txt)